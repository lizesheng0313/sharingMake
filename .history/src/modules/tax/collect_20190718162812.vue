...
import screening from "./util/constData";
    ...
    handleSearch() {
      ...
      for (let i = 0; i < this.activeList.length; i++) {
        for (let j = 0; j < this.screeningList[i].list.length; j++) {
          if (this.activeList[i][j]) {
            if (i == 0) {
              let cur = screening.idValidStatus[this.activeList[i][j]];
              this.ruleForm.idValidStatus.push(cur);
              console.log(this.ruleForm.idValidStatus)
              console.log(thsi.ruleForm)
            } else if (i == 1) {
              let cur = screening.reportStatus[this.activeList[i][j]];
              this.ruleForm.reportStatus.push(cur);
            } else if (i == 2) {
              let cur = screening.empStatus[this.activeList[i][j]];
              this.ruleForm.empStatus = cur;
            } else if (i == 3) {
              let cur = screening.iscgl[this.activeList[i][j]];
              this.ruleForm.empStatus = cur;
            } else if (i == 4) {
              let cur = screening.workerType[this.activeList[i][j]];
