      ...
      <div class="screening">
        ...
        <span>删除</span>
          ...
          <el-table :data="tableData" class="check-staff_table">
            ...
            <el-table-column prop="address" label="工资标准"></el-table-column>
            <el-table-column prop="address" label="基本工资"></el-table-column>
            <el-table-column prop="address" label="岗位工资"></el-table-column>
            <el-table-column prop="address" label="销售收入"></el-table-column>
            <el-table-column prop="address" label="绩效奖金"></el-table-column>
            <el-table-column prop="address" label="电脑补贴"></el-table-column>
