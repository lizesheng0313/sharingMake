          ...
          <el-row type="flex" class="screening-box" align="middle">
            ...
            <el-col>
              <span
                ...
                :class="{active:ruleForm.idValidStatus.indexOf(key) >-1,active:ruleForm.reportStatus.length==0}"
              >{{value}}</span>
            </el-col>
          </el-row>
          <el-row type="flex" class="screening-box" align="middle">
            ...
            <el-col>
              <span
                ...
                :class="{active:ruleForm.reportStatus.indexOf(key) >-1,active:ruleForm.reportStatus.length==0}"
              >{{value}}</span>
            </el-col>
          </el-row>
          <el-row type="flex" class="screening-box" align="middle">
