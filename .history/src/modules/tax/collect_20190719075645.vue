...
// import { format } from "../../util/constData";
...
export default {
  ...
  methods: {
    ...
    handleSearch() {
      ...
      console.log(this.ruleForm.reportFinishTimeStart)
      this.searchForm.reportFinishTimeEnd = this.format(
        "yyyy-MM-dd",
        this.updatedDate[1]
      );
      ...
      this.searchForm.updateTimeEnd = this.format(
        "yyyy-MM-dd",
