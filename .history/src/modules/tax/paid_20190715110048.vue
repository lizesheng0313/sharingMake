            ...
            >
              ...
              <el-table-column prop="name" label="姓名" width="140">
                <template slot-scope="scope">
                  <span class="table-name" @click="handleCollectionName">{{scope.row.name }}</span>
                </template>
              </el-table-column>
              <el-table-column prop="address" label="序号" width="140"></el-table-column>
              <el-table-column prop="address" label="纳税主体名称" width="140"></el-table-column>
              <el-table-column prop="address" label="纳税人识别号" width="140"></el-table-column>
              <el-table-column prop="address" label="法定代表人" width="140"></el-table-column>
              <el-table-column prop="address" label="备注" width="140"></el-table-column>
              <el-table-column prop="address" label="操作" width="140"></el-table-column>
            </el-table>
            <el-pagination
              :page-size="20"
              :pager-count="11"
