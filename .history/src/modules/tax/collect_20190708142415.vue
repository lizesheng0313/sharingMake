    ...
    <div class="tax-content">
      ...
      <div class="screening">
        ...
        <span>删除</span>
          ...
          <el-table :data="tableData" class="check-staff_table">
            ...
            <el-table-column prop="address" label="人员状态"></el-table-column>
            <el-table-column prop="address" label="报送状态"></el-table-column>
            <el-table-column prop="address" label="身份证验证状态"></el-table-column>
            <el-table-column prop="address" label="是否雇员"></el-table-column>
            <el-table-column prop="address" label="手机号码"></el-table-column>
            <el-table-column prop="address" label="国籍"></el-table-column>
            <el-table-column prop="address" label="任职受雇日期"></el-table-column>
            <el-table-column prop="address" label="离职日期"></el-table-column>
