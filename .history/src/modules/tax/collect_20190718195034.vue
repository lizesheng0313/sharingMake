      ...
      <el-dialog :visible.sync="isShowScreening" width="52%" center class="screen-dialog">
        <div class="screening-wapper">
          <el-row type="flex" class="screening-box" align="middle">
            ...
            <el-col>
              <span :class="{active:idValidStatus}" @click="idValidStatus=!idValidStatus">不限</span>
              <span
          ...
          <el-row type="flex" class="screening-box" align="middle">
            ...
            <el-col>
              <span :class="{active:reportStatus}" @click="reportStatus=!reportStatus">不限</span>
              <span
          ...
          <el-row type="flex" class="screening-box" align="middle">
            ...
            <el-col>
              <span :class="{active:workerType}" @click="workerType=!workerType">不限</span>
              <span
