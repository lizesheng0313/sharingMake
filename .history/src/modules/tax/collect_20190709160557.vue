<template>
  <div>
    <div class="tax el-diy-month" v-if="isShowInfoColl">
      <header class="header">
        <el-row type="flex">
          <el-col :span="12">
            <span>人员信息采集</span>
            ...
            >
              ...
              <el-table-column prop="name" label="姓名" width="140">
                <template slot-scope="scope">
                  <span class="table-name" @click="isShowInfoColl=false">{{scope.row.name }}</span>
                </template>
              </el-table-column>
    ...
    <info-collection v-if="!isShowInfoColl"></info-collection>
  </div>
</template>
<script>
