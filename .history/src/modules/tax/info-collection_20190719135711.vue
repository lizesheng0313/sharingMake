            ...
            <el-row type="flex" justify="center">
              <el-col :span="7">
                <el-form-item label="证件类型">
                  <el-select v-model="ruleForm.idType" prop="idType" placeholder="请选择">
                    <el-option
                ...
                <el-form-item label="是否存在以下情形">
                  <el-checkbox-group v-model="situation">
                    <el-checkbox label="残疾"></el-checkbox>
                    <el-checkbox label="烈属"></el-checkbox>
                    <el-checkbox label="孤老"></el-checkbox>
                  </el-checkbox-group>
                </el-form-item>
...
export default {
  ...
  mounted() {
    ...
    if (this.ruleForm.disabilityYn == "Y") {
      this.situation.push("残疾");
    }
    if (this.ruleForm.martyrFamilyYn == "Y") {
      this.situation.push("烈属");
    }
    if (this.ruleForm.lonelyOldYn == "Y") {
      this.situation.push("孤老");
    }
  },
  data() {
    return {
