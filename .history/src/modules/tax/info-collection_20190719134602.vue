              ...
              <el-col :span="7">
                ...
                <el-form-item label="是否存在以下情形">
                  <el-checkbox-group v-model="situation">
                    <el-checkbox label="disabilityYn" value="disabilityYn"></el-checkbox>
                    <el-checkbox label="烈属" value="martyrFamilyYn"></el-checkbox>
                    <el-checkbox label="孤老" value="lonelyOldYn"></el-checkbox>
                  </el-checkbox-group>
                </el-form-item>
