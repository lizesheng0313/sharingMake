    ...
    <div class="tax-content">
      ...
      <div class="screening">
        <div class="clearfix">
          ...
          <div class="right">
            <el-button type="primary" class="add-import">下载累计值</el-button>
            <el-button type="default" class="add-import">重下累计值</el-button>
          </div>
        </div>
        <div class="clearfix check-staff-menu">
          ...
          ></el-input>
          <div class="right">
            <el-button type="primary" class="add-import">导出</el-button>
          </div>
        </div>
