          ...
          <el-row type="flex" class="screening-box" align="middle">
            ...
            <el-col>
              <span
                ...
                :class="{'active':ruleForm.idValidStatus.length>0?ruleForm.idValidStatus.indexOf(key) >-1:key==''}"
              >{{value}}</span>
            </el-col>
          </el-row>
          <el-row type="flex" class="screening-box" align="middle">
            ...
            <el-col>
              <span
                ...
                :class="{'active':ruleForm.reportStatus.length>0?ruleForm.reportStatus.indexOf(key) >-1:key==''}"
              >{{value}}</span>
            </el-col>
          </el-row>
          <el-row type="flex" class="screening-box" align="middle">
          ...
          <el-row type="flex" class="screening-box" align="middle">
            ...
            <el-col>
              <span
                ...
                :class="{'active':ruleForm.workerType.length>0?ruleForm.workerType.indexOf(key) >-1:key==''}"
              >{{value}}</span>
            </el-col>
          </el-row>
          <el-row type="flex" class="screening-box" align="middle">
...
export default {
  ...
  methods: {
    ...
    handleSelectScreening(key, obj) {
      ...
      } else if (index > -1 && this.ruleForm[obj].length > 1 && key != "") {
