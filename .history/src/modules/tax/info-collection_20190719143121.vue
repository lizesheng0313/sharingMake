            ...
            <el-row type="flex" justify="center">
              <el-col :span="7">
                <el-form-item label="证件类型">
                  <el-select v-model="employeeFormData.idType" prop="idType" placeholder="请选择">
                    <el-option
                ...
                <el-form-item label="残疾证号">
                  <el-input v-model="employeeFormData.dsability"></el-input>
                </el-form-item>
              </el-col>
            ...
            <el-row type="flex" justify="center">
              <el-col :span="7">
                ...
                <el-form-item label="任职受雇从业日期" prop="empDay">
                  <el-date-picker v-model="employeeFormData.empDay" type="date" placeholder="选择日期"></el-date-picker>
                </el-form-item>
              </el-col>
              <el-col :span="7" class="right-input-box">
