<template>
  <div class="check-staff el-diy-month">
    ...
    <div class="clearfix check-staff-menu">
      <el-dropdown trigger="click left">
        <el-button type="default">
          更多
          <i class="iconsanjiao iconfont"></i>
        </el-button>
        <el-dropdown-menu slot="dropdown">
          <el-dropdown-item v-for="(item,index) in selectYear" :key="index">{{item}}</el-dropdown-item>
        </el-dropdown-menu>
      </el-dropdown>
      <el-input
...
export default {
  ...
  methods: {
    getList() {
      this.$store.dispatch("cumulativePageStore/apiTaxTotalBaseList");
    },
    handleDelete() {
