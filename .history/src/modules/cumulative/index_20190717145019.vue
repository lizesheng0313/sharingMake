<template>
  <div class="check-staff el-diy-month cumulative">
    ...
    <import-data
      :isShowIncrease="isShowIncrease"
      :apiCheck="'/api/taxTotalBase/importTaxTotalBaseCheck'"
      :apiDownloadLog="'/api/taxTotalBase/importTaxTotalBaseSuccess'"
    ...
    >
      ...
      <div class="select-file">
        <el-upload
          ...
          action="/api/taxTotalBase/importTaxTotalBaseCheck"
          :limit="1"
          :file-list="fileList"
        ...
        <p>
          ...
          <span>
            <a href="/api/taxTotalBase/downloadTemplate">下载模板</a>
          </span>
        </p>
