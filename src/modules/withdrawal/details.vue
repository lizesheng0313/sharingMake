  ...
  <div class="content templates" id="account-wrap">
    ...
    <el-row type="flex" class="rows">
      <el-col :span="8" style="position: relative;">
        ...
        <div class="btns">
          <el-button type="primary" @click="handleWithdrawal" v-if="privilegeVoList.includes('salary.account.psalaryAccount.withdraw')">提现</el-button>
<!--          账户信息-余额提现-->
        </div>
      </el-col>
    </el-row>
                ...
                <el-col :span="20">
                  <div>
                    <el-button
                      ...
                      style="margin-left: 0"
                      v-show="true"
                      v-if="privilegeVoList.includes('salary.account.psalaryAccount.changePwd')"
