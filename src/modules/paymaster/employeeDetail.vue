          ...
          <div class="employee-detail-con">
            ...
            <div class="base-info-con">
              ...
              <el-form label-width="150px" :model="baseForm" ref="baseForm" v-else>
                    ...
                    <el-row style="display: flex">
                        ...
                        <div style="flex:1">
                            <el-form-item label="工资银行账号：" prop="wageCardNum" :rules="[{required:false,validator:validateBankId,trigger:'blur'}]">
            ...
            <div class="insured-info-con">
                  <el-form label-width="140px" v-if="!isInsuredEdit">
                      ...
                      <el-row>
                        <el-col :span="12"><el-form-item label="是否转正：">{{this.insuredForm.regularEmpYn | regularEmpYn }}</el-form-item></el-col>
                      ...
                      <el-row style="display: flex">
                        ...
                        <div style="flex:1">
                          <el-form-item label="任职受雇从业类型" prop="workerType" :rules="{required: true, message: '请选择任职受雇从业类型', trigger: 'change'}">
                            <el-select v-model="insuredForm.workerType" placeholder="请选择任职受雇从业类型" >
