    ...
    <div class="participant-form-warp">
      ...
      >
        ...
        <el-form-item label="证件类型：" prop="idCardType">
          ...
          <p v-if="isEdit&&!lessCanEdit" style="font-size: 12px;color: #999;">如本仲裁参与人参与向北海仲裁委提交的仲裁案件，请仅选择身份证并填写身份证号</p>
        ...
        <el-form-item v-if="!propParams&&!isreadonly" label="附件上传：" prop="" class="is-required">
          <el-row>
            <el-col :span="12">身份证件正面</el-col>
            <el-col :span="12">身份证件反面</el-col>
          </el-row>
          <el-row>
            <el-col :span="12">
              <el-upload
              ...
              >
                <el-button v-if="isEdit" size="small" icon="el-icon-upload" type="primary">点击上传</el-button>
              </el-upload>
            </el-col>
            <el-col :span="12">
              <el-upload
...
<script>
  ...
  export default {
          ...
          idCardNo: [
            {
              ...
              validator: (rule, value, callback) => {
                ...
                if (value === ""||!value) {
                  ...
                  let currentIdCardType = t.participantFormData.idCardType;
                  if(t.participantFormData.idCardType){
                    let isTrue = true;
                    switch (t.participantFormData.idCardType) {
                      case 1:{
                        //军官证
                        if(value.length!==8){
                          isTrue = false
    ...
    methods: {
      setInitData(){
        const t = this;
        t.frontKeyList.push({name:t.participantFormData.frontKeyBase.fileName || ''});
        t.behindKeyList.push({name:t.participantFormData.behindKeyBase.fileName  || '' });
        t.identifyKeyList.push({name:t.participantFormData.identifyKeyBase?t.participantFormData.identifyKeyBase.fileName :'' });
        t.postKeyList.push({name:t.participantFormData.postKeyBase?t.participantFormData.postKeyBase.fileName:''});
      },
