    ...
    >
      <div class="import-con">
        ...
        <div class="screening-wapper">
          ...
          <el-form :model="paybackForm" ref="paybackForm" class="demo-ruleForm">
            ...
            <div style="padding:0 20px;margin: 30px 0px 0px 0px">
              <el-table :data="paybackForm.importSupplementIncuredVo" border height="300">
                ...
                <el-table-column label="个人缴纳金额">
                  <template slot-scope="scope">
                    <el-form-item :prop="'importSupplementIncuredVo.' + scope.$index +'.personMoney'"
                ...
                <el-table-column label="公司缴纳金额">
                  <template slot-scope="scope">
                    <el-form-item :prop="'importSupplementIncuredVo.' + scope.$index +'.companyMoney'" :rules="{validator: validateNumber, message: '请输入正确数值', trigger: 'blur'}">
