      ...
      <div class="attrition-content">
        <div class="screening">
          <div class="clearfix check-staff-menu">
            ...
            <div class="right">
              <el-button type="primary" class="add-import">快速增减员</el-button>
              <el-popover
                ref="popMore"
          ...
          <el-form :model="ruleForm" ref="screenForm" label-width="100px" class="demo-ruleForm">
            ...
            <div class="shortCon">
              <el-form-item label="参保城市" label-width="20%">
                <el-select v-model="ruleForm.city" placeholder="请选择参保城市" v-loading="taxSubIdLoading">
            ...
            <div class="shortCon">
              <el-form-item label="参保方案" label-width="20%">
                <el-select v-model="ruleForm.plan" placeholder="请选择参保方案" v-loading="taxSubIdLoading">
                  <el-option v-for="(item,index) in screenTaxOption" :label="item.taxSubName" :value="item.taxSubId" :key="index"></el-option>
                </el-select>
              </el-form-item>
            </div>
